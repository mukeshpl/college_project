			...
			<form method="post" action="login_form.php">
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					if ($result) {
    					...
    					$sql_update = "UPDATE products SET stock = $new_stock WHERE product_id = '$product_id'";
					...
					if($stock < $qty){
						...
						echo "
						<script>alert('The " . $stock . " stock is less than quantity');</script>;
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>DivineCart is an intuitive ecommerce platform offering a curated selection of spiritual products for seekers worldwide. With a user-friendly interface and secure payment gateway, it simplifies the process of purchasing devotional items such as incense sticks, prayer beads, and idols. Dive into a world of spiritual fulfillment with DivineCart, where convenience meets reverence.</p>
										</p></div>
									</div>
