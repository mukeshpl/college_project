	...
	<div class="container-fluid">
		...
		?>
				...
				if (isset($_POST["cmd"])) {
					...
					// Initialize an empty array to store items
							...
							while ($i <= $total_count) {
								...
								// Append item details to the items array
								$items[] = array(
								...
								// Print item details
								echo "<tr><td><p>$item_number_</p></td><td><p>$item_name_</p></td><td ><p>$quantity_</p></td><td ><p>$</p></td></tr>";
			...
			if($_SERVER['REQUEST_METHOD']=='POST'){
				...
				$message="Thank you for Ordering us!\n Your ordered successfully placed.\n Thank you for visiting us";


				$message .= "\n\n\nOrder details:\n \n";

				$message .= "Item number - Item name - quantity - Amount\n";
				foreach ($items as $item) {
					$message .= $item['item_number'] . "   -   " . $item['item_name'] . "   -   " . $item['quantity'] . "  -   " . $item['amount'] ."\n";
				}

				$message .="\n\nTotal amount: ".$total;
	
				$mailheader="From: ". "DIVINE CART" ."<". "divinecart@gmail.com". ">\r\n";
				$recipient=$email;
