...
mysqli_query($con,"insert into products (product_cat, product_brand,product_title,product_price, product_desc, product_image,product_keywords, stock) values ('$product_type','$brand','$product_name','$price','$details','$pic_name','$tags', '$stock')") or die ("query incorrect");
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        <label>Stock</label>
                        <input type="number" id="stock" min=1 required name="stock" class="form-control">
                      </div>
                    </div>
